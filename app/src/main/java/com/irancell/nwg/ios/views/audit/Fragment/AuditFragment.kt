...
import com.irancell.nwg.ios.views.audit.AuditAdapter
...
//    private val viewModel: AuditViewModel by viewModels()
    ...
    override fun initView() {
      viewBinding.txtGroup.text =  arguments?.get("groupId").toString()
...
//        var data1 = Data(photo?.toByteArray()?.toBase64(), null, null)
//
//
//
//        //Mock Sector Group
...
//
//        viewModel.insertAttribute(attribute.siteId, gson.toJson(attribute))
//
//        viewModel.updateImage(id, photo!!)
    }
}